"""
URL configuration for Hand_Gesture_Based_Virtual_Mouse project.
...
from Hand_Gesture_Based_Virtual_Mouse import views as mainView
...
urlpatterns = [
    ...
    path("overview/", usr.overview, name="overview"),
    path('gesture/', usr.gesture, name='gesture'),
